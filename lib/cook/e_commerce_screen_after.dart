...
class ECommerceScreen extends StatelessWidget {
  ...
  Widget _buildToggleBar(BuildContext context) {
    return Row(
      children: <Widget>[
        Flexible(child: _buildToggleItem(context, 'Ordering', selected: true),),
        Flexible(child: _buildToggleItem(context, 'Formal Wear'),),
        Flexible(child: _buildToggleItem(context, 'Casual Wea'),),
      ],
    );
  }

  Widget _buildToggleItem(BuildContext context, String text, {bool selected = false}) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Text(
        text,
